...
sed -i "s/__version__ = .*/__version__ = \"${VERSION}\"/g" python/raft_dask/raft_dask/__init__.py

# setup.py versions
sed -i "s/version=.*,/version=\"${VERSION}\",/g" python/pylibraft/pylibraft/__init__.py
sed -i "s/version=.*,/version=\"${VERSION}\",/g" python/raft_dask/raft_dask/__init__.py
