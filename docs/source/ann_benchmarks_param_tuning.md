...
| `dataset_memtype` | `build_param` | N | "device", "host", "mmap" | "device" | What memory type should the dataset reside?                                                                                                                                       |
| `query_memtype` | `search_params` | N | "device", "host", "mmap" | "device | What memory type should the queries reside? |
