...
| RAFT_ENABLE_NN_DEPENDENCIES | ON, OFF | OFF | Searches for dependencies of nearest neighbors API, and compiles them if not found. Needed for `raft::spatial::knn` |
