...
const std::vector<RngInputs<uint32_t>> inputs_u32 = {
  {0.1f, 32 * 1024, 0, 20, RNG_Uniform, kGenPhilox, 1234ULL},
  {0.1f, 8 * 1024, 0, 20, RNG_Uniform, kGenPhilox, 1234ULL},
  {0.1f, 32 * 1024, 0, 20, RNG_Uniform, kGenTaps, 1234ULL},
  {0.1f, 8 * 1024, 0, 20, RNG_Uniform, kGenTaps, 1234ULL},
  {0.1f, 32 * 1024, 0, 20, RNG_Uniform, kGenKiss99, 1234ULL},
  {0.1f, 8 * 1024, 0, 20, RNG_Uniform, kGenKiss99, 1234ULL}};
