...
const std::vector<RngInputs<float>> inputsf = {
  {0.0055, 32 * 1024, 1.f, 1.f, RNG_Normal, kGenPhilox, 1234ULL},
  {0.011, 8 * 1024, 1.f, 1.f, RNG_Normal, kGenPhilox, 1234ULL},
  {0.05, 32 * 1024, 1.f, 1.f, RNG_LogNormal, kGenPhilox, 1234ULL},
  {0.1, 8 * 1024, 1.f, 1.f, RNG_LogNormal, kGenPhilox, 1234ULL},
  {0.003, 32 * 1024, -1.f, 1.f, RNG_Uniform, kGenPhilox, 1234ULL},
  {0.005, 8 * 1024, -1.f, 1.f, RNG_Uniform, kGenPhilox, 1234ULL},
  {0.005, 32 * 1024, 1.f, 1.f, RNG_Gumbel, kGenPhilox, 1234ULL},
  {0.01, 8 * 1024, 1.f, 1.f, RNG_Gumbel, kGenPhilox, 1234ULL},
  {0.005, 32 * 1024, 1.f, 1.f, RNG_Logistic, kGenPhilox, 1234ULL},
  {0.01, 8 * 1024, 1.f, 1.f, RNG_Logistic, kGenPhilox, 1234ULL},
  {0.008, 32 * 1024, 1.f, 1.f, RNG_Exp, kGenPhilox, 1234ULL},
  {0.015, 8 * 1024, 1.f, 1.f, RNG_Exp, kGenPhilox, 1234ULL},
  {0.0125, 32 * 1024, 1.f, 1.f, RNG_Rayleigh, kGenPhilox, 1234ULL},
  {0.025, 8 * 1024, 1.f, 1.f, RNG_Rayleigh, kGenPhilox, 1234ULL},
  {0.02, 32 * 1024, 1.f, 1.f, RNG_Laplace, kGenPhilox, 1234ULL},
  {0.04, 8 * 1024, 1.f, 1.f, RNG_Laplace, kGenPhilox, 1234ULL},

  {0.0055, 32 * 1024, 1.f, 1.f, RNG_Normal, kGenTaps, 1234ULL},
  {0.011, 8 * 1024, 1.f, 1.f, RNG_Normal, kGenTaps, 1234ULL},
  {0.05, 32 * 1024, 1.f, 1.f, RNG_LogNormal, kGenTaps, 1234ULL},
  {0.1, 8 * 1024, 1.f, 1.f, RNG_LogNormal, kGenTaps, 1234ULL},
  {0.003, 32 * 1024, -1.f, 1.f, RNG_Uniform, kGenTaps, 1234ULL},
  {0.005, 8 * 1024, -1.f, 1.f, RNG_Uniform, kGenTaps, 1234ULL},
  {0.005, 32 * 1024, 1.f, 1.f, RNG_Gumbel, kGenTaps, 1234ULL},
  {0.01, 8 * 1024, 1.f, 1.f, RNG_Gumbel, kGenTaps, 1234ULL},
  {0.005, 32 * 1024, 1.f, 1.f, RNG_Logistic, kGenTaps, 1234ULL},
  {0.01, 8 * 1024, 1.f, 1.f, RNG_Logistic, kGenTaps, 1234ULL},
  {0.008, 32 * 1024, 1.f, 1.f, RNG_Exp, kGenTaps, 1234ULL},
  {0.015, 8 * 1024, 1.f, 1.f, RNG_Exp, kGenTaps, 1234ULL},
  {0.0125, 32 * 1024, 1.f, 1.f, RNG_Rayleigh, kGenTaps, 1234ULL},
  {0.025, 8 * 1024, 1.f, 1.f, RNG_Rayleigh, kGenTaps, 1234ULL},
  {0.02, 32 * 1024, 1.f, 1.f, RNG_Laplace, kGenTaps, 1234ULL},
  {0.04, 8 * 1024, 1.f, 1.f, RNG_Laplace, kGenTaps, 1234ULL},

  {0.0055, 32 * 1024, 1.f, 1.f, RNG_Normal, kGenKiss99, 1234ULL},
  {0.011, 8 * 1024, 1.f, 1.f, RNG_Normal, kGenKiss99, 1234ULL},
  {0.05, 32 * 1024, 1.f, 1.f, RNG_LogNormal, kGenKiss99, 1234ULL},
  {0.1, 8 * 1024, 1.f, 1.f, RNG_LogNormal, kGenKiss99, 1234ULL},
  {0.003, 32 * 1024, -1.f, 1.f, RNG_Uniform, kGenKiss99, 1234ULL},
  {0.005, 8 * 1024, -1.f, 1.f, RNG_Uniform, kGenKiss99, 1234ULL},
  {0.005, 32 * 1024, 1.f, 1.f, RNG_Gumbel, kGenKiss99, 1234ULL},
  {0.01, 8 * 1024, 1.f, 1.f, RNG_Gumbel, kGenKiss99, 1234ULL},
  {0.005, 32 * 1024, 1.f, 1.f, RNG_Logistic, kGenKiss99, 1234ULL},
  {0.01, 8 * 1024, 1.f, 1.f, RNG_Logistic, kGenKiss99, 1234ULL},
  {0.008, 32 * 1024, 1.f, 1.f, RNG_Exp, kGenKiss99, 1234ULL},
  {0.015, 8 * 1024, 1.f, 1.f, RNG_Exp, kGenKiss99, 1234ULL},
  {0.0125, 32 * 1024, 1.f, 1.f, RNG_Rayleigh, kGenKiss99, 1234ULL},
  {0.025, 8 * 1024, 1.f, 1.f, RNG_Rayleigh, kGenKiss99, 1234ULL},
  {0.02, 32 * 1024, 1.f, 1.f, RNG_Laplace, kGenKiss99, 1234ULL},
  {0.04, 8 * 1024, 1.f, 1.f, RNG_Laplace, kGenKiss99, 1234ULL}};
...
const std::vector<RngInputs<double>> inputsd = {
  {0.0055, 32 * 1024, 1.0, 1.0, RNG_Normal, kGenPhilox, 1234ULL},
  {0.011, 8 * 1024, 1.0, 1.0, RNG_Normal, kGenPhilox, 1234ULL},
  {0.05, 32 * 1024, 1.0, 1.0, RNG_LogNormal, kGenPhilox, 1234ULL},
  {0.1, 8 * 1024, 1.0, 1.0, RNG_LogNormal, kGenPhilox, 1234ULL},
  {0.003, 32 * 1024, -1.0, 1.0, RNG_Uniform, kGenPhilox, 1234ULL},
  {0.005, 8 * 1024, -1.0, 1.0, RNG_Uniform, kGenPhilox, 1234ULL},
  {0.005, 32 * 1024, 1.0, 1.0, RNG_Gumbel, kGenPhilox, 1234ULL},
  {0.01, 8 * 1024, 1.0, 1.0, RNG_Gumbel, kGenPhilox, 1234ULL},
  {0.005, 32 * 1024, 1.0, 1.0, RNG_Logistic, kGenPhilox, 1234ULL},
  {0.01, 8 * 1024, 1.0, 1.0, RNG_Logistic, kGenPhilox, 1234ULL},
  {0.008, 32 * 1024, 1.0, 1.0, RNG_Exp, kGenPhilox, 1234ULL},
  {0.015, 8 * 1024, 1.0, 1.0, RNG_Exp, kGenPhilox, 1234ULL},
  {0.0125, 32 * 1024, 1.0, 1.0, RNG_Rayleigh, kGenPhilox, 1234ULL},
  {0.025, 8 * 1024, 1.0, 1.0, RNG_Rayleigh, kGenPhilox, 1234ULL},
  {0.02, 32 * 1024, 1.0, 1.0, RNG_Laplace, kGenPhilox, 1234ULL},
  {0.04, 8 * 1024, 1.0, 1.0, RNG_Laplace, kGenPhilox, 1234ULL},

  {0.0055, 32 * 1024, 1.0, 1.0, RNG_Normal, kGenTaps, 1234ULL},
  {0.011, 8 * 1024, 1.0, 1.0, RNG_Normal, kGenTaps, 1234ULL},
  {0.05, 32 * 1024, 1.0, 1.0, RNG_LogNormal, kGenTaps, 1234ULL},
  {0.1, 8 * 1024, 1.0, 1.0, RNG_LogNormal, kGenTaps, 1234ULL},
  {0.003, 32 * 1024, -1.0, 1.0, RNG_Uniform, kGenTaps, 1234ULL},
  {0.005, 8 * 1024, -1.0, 1.0, RNG_Uniform, kGenTaps, 1234ULL},
  {0.005, 32 * 1024, 1.0, 1.0, RNG_Gumbel, kGenTaps, 1234ULL},
  {0.01, 8 * 1024, 1.0, 1.0, RNG_Gumbel, kGenTaps, 1234ULL},
  {0.005, 32 * 1024, 1.0, 1.0, RNG_Logistic, kGenTaps, 1234ULL},
  {0.01, 8 * 1024, 1.0, 1.0, RNG_Logistic, kGenTaps, 1234ULL},
  {0.008, 32 * 1024, 1.0, 1.0, RNG_Exp, kGenTaps, 1234ULL},
  {0.015, 8 * 1024, 1.0, 1.0, RNG_Exp, kGenTaps, 1234ULL},
  {0.0125, 32 * 1024, 1.0, 1.0, RNG_Rayleigh, kGenTaps, 1234ULL},
  {0.025, 8 * 1024, 1.0, 1.0, RNG_Rayleigh, kGenTaps, 1234ULL},
  {0.02, 32 * 1024, 1.0, 1.0, RNG_Laplace, kGenTaps, 1234ULL},
  {0.04, 8 * 1024, 1.0, 1.0, RNG_Laplace, kGenTaps, 1234ULL},

  {0.0055, 32 * 1024, 1.0, 1.0, RNG_Normal, kGenKiss99, 1234ULL},
  {0.011, 8 * 1024, 1.0, 1.0, RNG_Normal, kGenKiss99, 1234ULL},
  {0.05, 32 * 1024, 1.0, 1.0, RNG_LogNormal, kGenKiss99, 1234ULL},
  {0.1, 8 * 1024, 1.0, 1.0, RNG_LogNormal, kGenKiss99, 1234ULL},
  {0.003, 32 * 1024, -1.0, 1.0, RNG_Uniform, kGenKiss99, 1234ULL},
  {0.005, 8 * 1024, -1.0, 1.0, RNG_Uniform, kGenKiss99, 1234ULL},
  {0.005, 32 * 1024, 1.0, 1.0, RNG_Gumbel, kGenKiss99, 1234ULL},
  {0.01, 8 * 1024, 1.0, 1.0, RNG_Gumbel, kGenKiss99, 1234ULL},
  {0.005, 32 * 1024, 1.0, 1.0, RNG_Logistic, kGenKiss99, 1234ULL},
  {0.01, 8 * 1024, 1.0, 1.0, RNG_Logistic, kGenKiss99, 1234ULL},
  {0.008, 32 * 1024, 1.0, 1.0, RNG_Exp, kGenKiss99, 1234ULL},
  {0.015, 8 * 1024, 1.0, 1.0, RNG_Exp, kGenKiss99, 1234ULL},
  {0.0125, 32 * 1024, 1.0, 1.0, RNG_Rayleigh, kGenKiss99, 1234ULL},
  {0.025, 8 * 1024, 1.0, 1.0, RNG_Rayleigh, kGenKiss99, 1234ULL},
  {0.02, 32 * 1024, 1.0, 1.0, RNG_Laplace, kGenKiss99, 1234ULL},
  {0.04, 8 * 1024, 1.0, 1.0, RNG_Laplace, kGenKiss99, 1234ULL}};
...
TEST(Rng, MeanError) {
  ...
  for (auto rtype : {kGenPhilox, kGenKiss99 /*, raft::random::kGenTaps */}) {
    Rng r(seed, rtype);
...
const std::vector<RngNormalTableInputs<float>> inputsf_t = {
  {0.0055, 32, 1024, 1.f, 1.f, kGenPhilox, 1234ULL},
  {0.011, 8, 1024, 1.f, 1.f, kGenPhilox, 1234ULL},
  {0.0055, 32, 1024, 1.f, 1.f, kGenTaps, 1234ULL},
  {0.011, 8, 1024, 1.f, 1.f, kGenTaps, 1234ULL},
  {0.0055, 32, 1024, 1.f, 1.f, kGenKiss99, 1234ULL},
  {0.011, 8, 1024, 1.f, 1.f, kGenKiss99, 1234ULL}};
...
const std::vector<RngNormalTableInputs<double>> inputsd_t = {
  {0.0055, 32, 1024, 1.0, 1.0, kGenPhilox, 1234ULL},
  {0.011, 8, 1024, 1.0, 1.0, kGenPhilox, 1234ULL},
  {0.0055, 32, 1024, 1.0, 1.0, kGenTaps, 1234ULL},
  {0.011, 8, 1024, 1.0, 1.0, kGenTaps, 1234ULL},
  {0.0055, 32, 1024, 1.0, 1.0, kGenKiss99, 1234ULL},
  {0.011, 8, 1024, 1.0, 1.0, kGenKiss99, 1234ULL}};
