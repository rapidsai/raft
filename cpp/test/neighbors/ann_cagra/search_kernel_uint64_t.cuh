...
#define instantiate_kernel_selection(                                                             \
  DATASET_DESCRIPTOR, TEAM_SIZE, MAX_DATASET_DIM, DATA_T, INDEX_T, DISTANCE_T, SAMPLE_FILTER_T)   \
  extern template void                                                                            \
  select_and_run<TEAM_SIZE,                                                                       \
                 MAX_DATASET_DIM,                                                                 \
                 raft::neighbors::cagra::detail::DATASET_DESCRIPTOR<DATA_T, INDEX_T, DISTANCE_T>, \
                 SAMPLE_FILTER_T>(                                                                \
    raft::neighbors::cagra::detail::DATASET_DESCRIPTOR<DATA_T, INDEX_T, DISTANCE_T> dataset_desc, \
