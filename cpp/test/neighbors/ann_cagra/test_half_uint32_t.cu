...
typedef AnnCagraAddNodesTest<float, half, std::uint32_t> AnnCagraAddNodesTestH_U32;
TEST_P(AnnCagraAddNodesTestH_U32, AnnCagraAddNodes) { this->testCagra(); }
