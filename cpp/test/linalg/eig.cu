 ...
 protected:
  void SetUp() override
  {
    ...
    auto cov_matrix_view =
      raft::make_matrix_view<T, raft::col_major>(cov_matrix.data(), params.n_row, params.n_col);
    auto eig_vectors_view =
      raft::make_matrix_view<T, raft::col_major>(eig_vectors.data(), params.n_row, params.n_col);
    auto eig_vals_view = raft::make_vector_view(eig_vals.data(), params.n_row);

    auto eig_vectors_jacobi_view = raft::make_matrix_view<T, raft::col_major>(
    ...
    auto cov_matrix_large_view =
      raft::make_matrix_view<T, raft::col_major>(cov_matrix_large.data(), params.n, params.n);
    auto eig_vectors_large_view =
      raft::make_matrix_view<T, raft::col_major>(eig_vectors_large.data(), params.n, params.n);
    auto eig_vals_large_view = raft::make_vector_view(eig_vals_large.data(), params.n);

    auto eig_vectors_jacobi_large_view = raft::make_matrix_view<T, raft::col_major>(
