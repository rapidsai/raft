...
//  #include <raft_internal/neighbors/naive_knn.cuh>
 ...
 auto check_unique_indices(const std::vector<T>& actual_idx,
                           ...
                           const std::vector<DistT>& actual_dist = nullptr)
 {
   size_t max_count;
                      ...
                      size_t max_duplicates = 0) -> testing::AssertionResult
 {
   ...
   if (test_unique)
     return check_unique_indices(actual_idx, rows, cols, max_duplicates, actual_dist);
   else
     return testing::AssertionSuccess();
 }
                     ...
                     double eps) -> testing::AssertionResult
 {
   ...
   for (size_t i = 0; i < n_queries; i++) {
     ...
     raft::neighbors::naive_distance_kernel<DistT, T, IdxT>
