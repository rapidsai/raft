...
instantiate_raft_spatial_knn_detail_rbc_eps_pass(std::int32_t, float, std::int32_t, std::int32_t);
instantiate_raft_spatial_knn_detail_rbc_eps_pass(std::int32_t, double, std::int32_t, std::int32_t);
