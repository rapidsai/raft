...
namespace raft::solver::gradient_descent {
    ...
    void minimize(const raft::handle_t& handle,
        ...
        detail::sgdFit(handle, A.data_handle(), A.extent(0), A.extent(1), b.data_handle(), x.data_handle(),
                       intercept_ptr, intercept.has_value(), params.batch_size, params.epochs, params.lr_type,
                       params.eta0, params.power_t, params.loss, params.penalty, params.alpha, params.l1_ratio,
                       params.shuffle, params.tol, params.n_iter_no_change, handle.get_stream());
