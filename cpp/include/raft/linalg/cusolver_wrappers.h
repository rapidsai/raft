...
inline auto cusolver_error_to_string(cusolverStatus_t err) -> const char* {
  switch (err) {
 ...
 */
template <typename T>
auto cusolverDngetrf(cusolverDnHandle_t handle, int m,  // NOLINT
                                 int n, T *A, int lda, T *Workspace,
                                 int *devIpiv, int *devInfo,
                                 cudaStream_t stream) -> cusolverStatus_t;

template <>
inline auto cusolverDngetrf(cusolverDnHandle_t handle,  // NOLINT
                                        int m, int n, float *A, int lda,
                                        float *Workspace, int *devIpiv,
                                        int *devInfo, cudaStream_t stream) -> cusolverStatus_t {
...
template <typename T>
auto cusolverDngetrf_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, int m, int n, T *A, int lda, int *Lwork) -> cusolverStatus_t;

template <>
inline auto cusolverDngetrf_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, int m, int n, float *A, int lda, int *Lwork) -> cusolverStatus_t {
  return cusolverDnSgetrf_bufferSize(handle, m, n, A, lda, Lwork);
}

template <>
inline auto cusolverDngetrf_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, int m, int n, double *A, int lda, int *Lwork) -> cusolverStatus_t {
 ...
 */
template <typename T>
auto cusolverDngetrs(cusolverDnHandle_t handle,  // NOLINT
                                 cublasOperation_t trans, int n, int nrhs,
                                 const T *A, int lda, const int *devIpiv, T *B,
                                 int ldb, int *devInfo, cudaStream_t stream) -> cusolverStatus_t;

template <>
inline auto cusolverDngetrs(cusolverDnHandle_t handle,  // NOLINT
 ...
 */
template <typename T>
auto cusolverDnsyevd_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo,
  int n, const T *A, int lda, const T *W, int *lwork) -> cusolverStatus_t;

template <>
inline auto cusolverDnsyevd_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo,
  int n, const float *A, int lda, const float *W, int *lwork) -> cusolverStatus_t {
...
inline auto cusolverDnsyevd_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo,
  int n, const double *A, int lda, const double *W, int *lwork) -> cusolverStatus_t {
 ...
 */
template <typename T>
auto cusolverDnsyevj(cusolverDnHandle_t handle,  // NOLINT
...
template <>
inline auto cusolverDnsyevj(  // NOLINT
  cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo,
  int n, float *A, int lda, float *W, float *work, int lwork, int *info,
  syevjInfo_t params, cudaStream_t stream) -> cusolverStatus_t {
  CUSOLVER_CHECK(cusolverDnSetStream(handle, stream));
...
template <typename T>
auto cusolverDnsyevj_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo,
  int n, const T *A, int lda, const T *W, int *lwork, syevjInfo_t params) -> cusolverStatus_t;

template <>
inline auto cusolverDnsyevj_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo,
  int n, const float *A, int lda, const float *W, int *lwork,
  syevjInfo_t params) -> cusolverStatus_t {
 ...
 */
template <typename T>
auto cusolverDnsyevd(cusolverDnHandle_t handle,  // NOLINT
                                 cusolverEigMode_t jobz, cublasFillMode_t uplo,
                                 int n, T *A, int lda, T *W, T *work, int lwork,
                                 int *devInfo, cudaStream_t stream) -> cusolverStatus_t;

template <>
inline auto cusolverDnsyevd(cusolverDnHandle_t handle,  // NOLINT
...
*/
template <typename T>
auto cusolverDnsyevdx_bufferSize(  // NOLINT
  ...
  int *h_meig, const T *W, int *lwork) -> cusolverStatus_t;

template <>
inline auto cusolverDnsyevdx_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, cusolverEigMode_t jobz, cusolverEigRange_t range,
  cublasFillMode_t uplo, int n, const float *A, int lda, float vl, float vu,
  int il, int iu, int *h_meig, const float *W, int *lwork) -> cusolverStatus_t {
...
inline auto cusolverDnsyevdx_bufferSize(  // NOLINT
  ...
  int il, int iu, int *h_meig, const double *W, int *lwork) -> cusolverStatus_t {
  return cusolverDnDsyevdx_bufferSize(handle, jobz, range, uplo, n, A, lda, vl,
                                      vu, il, iu, h_meig, W, lwork);
}

template <typename T>
auto cusolverDnsyevdx(  // NOLINT
  cusolverDnHandle_t handle, cusolverEigMode_t jobz, cusolverEigRange_t range,
  cublasFillMode_t uplo, int n, T *A, int lda, T vl, T vu, int il, int iu,
  int *h_meig, T *W, T *work, int lwork, int *devInfo, cudaStream_t stream) -> cusolverStatus_t;

template <>
inline auto cusolverDnsyevdx(  // NOLINT
  cusolverDnHandle_t handle, cusolverEigMode_t jobz, cusolverEigRange_t range,
 ...
 */
template <typename T>
auto cusolverDngesvd_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, int m, int n, int *lwork) -> cusolverStatus_t {
...
auto cusolverDngesvd(  // NOLINT
  ...
  T *rwork, int *devInfo, cudaStream_t stream) -> cusolverStatus_t;
template <>
inline auto cusolverDngesvd(  // NOLINT
  cusolverDnHandle_t handle, signed char jobu, signed char jobvt, int m, int n,
  float *A, int lda, float *S, float *U, int ldu, float *VT, int ldvt,
  float *work, int lwork, float *rwork, int *devInfo, cudaStream_t stream) -> cusolverStatus_t {
  CUSOLVER_CHECK(cusolverDnSetStream(handle, stream));
...
inline auto cusolverDngesvd(  // NOLINT
  ...
  double *work, int lwork, double *rwork, int *devInfo, cudaStream_t stream) -> cusolverStatus_t {
  CUSOLVER_CHECK(cusolverDnSetStream(handle, stream));
...
template <typename T>
inline auto CUSOLVERAPI cusolverDngesvdj_bufferSize(  // NOLINT
  ...
  int *lwork, gesvdjInfo_t params) -> cusolverStatus_t;
template <>
inline auto CUSOLVERAPI cusolverDngesvdj_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, cusolverEigMode_t jobz, int econ, int m, int n,
  const float *A, int lda, const float *S, const float *U, int ldu,
  const float *V, int ldv, int *lwork, gesvdjInfo_t params) -> cusolverStatus_t {
...
inline auto CUSOLVERAPI cusolverDngesvdj_bufferSize(  // NOLINT
  ...
  const double *V, int ldv, int *lwork, gesvdjInfo_t params) -> cusolverStatus_t {
  return cusolverDnDgesvdj_bufferSize(handle, jobz, econ, m, n, A, lda, S, U,
                                      ldu, V, ldv, lwork, params);
}
template <typename T>
inline auto CUSOLVERAPI cusolverDngesvdj(  // NOLINT
  cusolverDnHandle_t handle, cusolverEigMode_t jobz, int econ, int m, int n,
  T *A, int lda, T *S, T *U, int ldu, T *V, int ldv, T *work, int lwork,
  int *info, gesvdjInfo_t params, cudaStream_t stream) -> cusolverStatus_t;
template <>
inline auto CUSOLVERAPI cusolverDngesvdj(  // NOLINT
  cusolverDnHandle_t handle, cusolverEigMode_t jobz, int econ, int m, int n,
  float *A, int lda, float *S, float *U, int ldu, float *V, int ldv,
  float *work, int lwork, int *info, gesvdjInfo_t params, cudaStream_t stream) -> cusolverStatus_t {
  CUSOLVER_CHECK(cusolverDnSetStream(handle, stream));
 ...
 */
template <typename T>
auto cusolverDnpotrf_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, T *A, int lda,
  int *Lwork) -> cusolverStatus_t;

template <>
inline auto cusolverDnpotrf_bufferSize(  // NOLINT
...
template <typename T>
inline auto cusolverDnpotrf(cusolverDnHandle_t handle,  // NOLINT
 ...
 */
template <typename T>
auto cusolverDnpotrs(cusolverDnHandle_t handle,  // NOLINT
                                 cublasFillMode_t uplo, int n, int nrhs,
                                 const T *A, int lda, T *B, int ldb,
                                 int *devInfo, cudaStream_t stream) -> cusolverStatus_t;

template <>
inline auto cusolverDnpotrs(cusolverDnHandle_t handle,  // NOLINT
                                        cublasFillMode_t uplo, int n, int nrhs,
 ...
 */
template <typename T>
auto cusolverDngeqrf(cusolverDnHandle_t handle, int m,  // NOLINT
                                 int n, T *A, int lda, T *TAU, T *Workspace,
                                 int Lwork, int *devInfo, cudaStream_t stream) -> cusolverStatus_t;
template <>
inline auto cusolverDngeqrf(cusolverDnHandle_t handle,  // NOLINT
                                        int m, int n, float *A, int lda,
...
template <typename T>
auto cusolverDngeqrf_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, int m, int n, T *A, int lda, int *Lwork) -> cusolverStatus_t;
template <>
inline auto cusolverDngeqrf_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, int m, int n, float *A, int lda, int *Lwork) -> cusolverStatus_t {
 ...
 */
template <typename T>
auto cusolverDnorgqr(  // NOLINT
  cusolverDnHandle_t handle, int m, int n, int k, T *A, int lda, const T *tau,
  T *work, int lwork, int *devInfo, cudaStream_t stream) -> cusolverStatus_t;
template <>
inline auto cusolverDnorgqr(  // NOLINT
  cusolverDnHandle_t handle, int m, int n, int k, float *A, int lda,
  const float *tau, float *work, int lwork, int *devInfo, cudaStream_t stream) -> cusolverStatus_t {
  CUSOLVER_CHECK(cusolverDnSetStream(handle, stream));
...
template <typename T>
auto cusolverDnorgqr_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, int m, int n, int k, const T *A, int lda,
  const T *TAU, int *lwork) -> cusolverStatus_t;
template <>
inline auto cusolverDnorgqr_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, int m, int n, int k, const float *A, int lda,
  const float *TAU, int *lwork) -> cusolverStatus_t {
...
inline auto cusolverDnorgqr_bufferSize(  // NOLINT
  ...
  const double *TAU, int *lwork) -> cusolverStatus_t {
 ...
 */
template <typename T>
auto cusolverDnormqr(cusolverDnHandle_t handle,  // NOLINT
...
template <>
inline auto cusolverDnormqr(  // NOLINT
  ...
  int ldc, float *work, int lwork, int *devInfo, cudaStream_t stream) -> cusolverStatus_t {
  CUSOLVER_CHECK(cusolverDnSetStream(handle, stream));
...
inline auto cusolverDnormqr(  // NOLINT
  ...
  int ldc, double *work, int lwork, int *devInfo, cudaStream_t stream) -> cusolverStatus_t {
  CUSOLVER_CHECK(cusolverDnSetStream(handle, stream));
...
template <typename T>
auto cusolverDnormqr_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, cublasSideMode_t side, cublasOperation_t trans,
  int m, int n, int k, const T *A, int lda, const T *tau, const T *C, int ldc,
  int *lwork) -> cusolverStatus_t;

template <>
inline auto cusolverDnormqr_bufferSize(  // NOLINT
  cusolverDnHandle_t handle, cublasSideMode_t side, cublasOperation_t trans,
  int m, int n, int k, const float *A, int lda, const float *tau,
  const float *C, int ldc, int *lwork) -> cusolverStatus_t {
...
inline auto cusolverDnormqr_bufferSize(  // NOLINT
  ...
  const double *C, int ldc, int *lwork) -> cusolverStatus_t {
 ...
 */
template <typename T>
auto cusolverSpcsrqrBufferInfoBatched(  // NOLINT
  ...
  size_t *internalDataInBytes, size_t *workspaceInBytes) -> cusolverStatus_t;

template <>
inline auto cusolverSpcsrqrBufferInfoBatched(  // NOLINT
  cusolverSpHandle_t handle, int m, int n, int nnzA,
...
template <typename T>
auto cusolverSpcsrqrsvBatched(  // NOLINT
  cusolverSpHandle_t handle, int m, int n, int nnzA,
  const cusparseMatDescr_t descrA, const T *csrValA, const int *csrRowPtrA,
  const int *csrColIndA, const T *b, T *x, int batchSize, csrqrInfo_t info,
  void *pBuffer, cudaStream_t stream) -> cusolverStatus_t;

template <>
inline auto cusolverSpcsrqrsvBatched(  // NOLINT
  cusolverSpHandle_t handle, int m, int n, int nnzA,
  const cusparseMatDescr_t descrA, const float *csrValA, const int *csrRowPtrA,
  const int *csrColIndA, const float *b, float *x, int batchSize,
  csrqrInfo_t info, void *pBuffer, cudaStream_t stream) -> cusolverStatus_t {
