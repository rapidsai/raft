  ...
  cudaStream_t       stream)
{
  ...
  RAFT_CUSOLVER_TRY(cusolverDnSetStream(handle, stream));
  return cusolverDnXgesvdr_bufferSize(handle, params, jobu, jobv,
    m, n, k, p, niters, dataType, a, lda, dataType, Srand, dataType,
    Urand, ldUrand, dataType, Vrand, ldVrand, dataType,
  ...
  cudaStream_t       stream)
{
  cudaDataType dataType =
    std::is_same_v<T, float> ? CUDA_R_32F : CUDA_R_64F;
  RAFT_CUSOLVER_TRY(cusolverDnSetStream(handle, stream));
  return cusolverDnXgesvdr(handle, params, jobu, jobv,
    m, n, k, p, niters, dataType, a, lda, dataType, Srand, dataType,
    Urand, ldUrand, dataType, Vrand, ldVrand, dataType,
    bufferOnDevice, workspaceInBytesOnDevice, bufferOnHost, workspaceInBytesOnHost, d_info);
}
