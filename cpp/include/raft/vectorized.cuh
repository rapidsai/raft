...
#define CoalescedAccess_CHECK_TYPE(T)                                    \
 ...
 public:
  ...
  static HDI bool isAligned(PtrT p) noexcept {
  ...
  static HDI bool areSameAlignOffsets(PtrT a, PtrS b) noexcept {
    CoalescedAccess_CHECK_TYPE(PtrT);
  ...
  template <typename PtrT>
  static HDI PtrT roundUp(PtrT p) noexcept {
    CoalescedAccess_CHECK_TYPE(PtrT);
  ...
  template <typename PtrT>
  static HDI PtrT roundDown(PtrT p) noexcept {
    CoalescedAccess_CHECK_TYPE(PtrT);
    auto x = reinterpret_cast<std::size_t>(p);
