 ...
 */
template <typename m_t, typename idx_t = int>
RAFT_KERNEL_ void getUpperTriangular(const m_t* src, m_t* dst, idx_t n_rows, idx_t n_cols, idx_t k)
{
  idx_t idx = threadIdx.x + blockDim.x * blockIdx.x;
 ...
 */
template <typename m_t, typename idx_t = int>
RAFT_KERNEL_ void copyVectorToMatrixDiagonal(const m_t* vec, m_t* matrix, idx_t lda, idx_t k)
{
  idx_t idx = threadIdx.x + blockDim.x * blockIdx.x;
 ...
 */
template <typename m_t, typename idx_t = int>
RAFT_KERNEL_ void copyVectorFromMatrixDiagonal(m_t* vec, const m_t* matrix, idx_t lda, idx_t k)
{
  idx_t idx = threadIdx.x + blockDim.x * blockIdx.x;
 ...
 */
template <typename m_t, typename idx_t = int>
RAFT_KERNEL_ void matrixDiagonalInverse(m_t* in, idx_t len)
{
  idx_t idx = threadIdx.x + blockDim.x * blockIdx.x;
