...
// template <typename T>
// void print_vals(raft::resources const& handle, T* out, int len)
// {
//   cudaStream_t stream = raft::resource::get_cuda_stream(handle);
//   auto h_out          = raft::make_host_vector<T>(len);
//   raft::copy<T>(h_out.data_handle(), out, len, stream);
//   int limit = (int)len;
...
//   SparseEncoder(
//     raft::resources const& handle, int* featIdValues, int num_rows, int full_id_len, int
//     num_feats);
//   ~SparseEncoder();
...
//  * */
// template <typename ValueType, typename IndexType>
// void SparseEncoder<ValueType, IndexType>::save(raft::resources const& handle, std::string
// save_path)
// {
//   cudaStream_t stream = raft::resource::get_cuda_stream(handle);
...
//                                                raft::device_vector_view<IndexType, int64_t> rows,
//                                                raft::device_vector_view<IndexType, int64_t>
//                                                columns, raft::device_vector_view<ValueType,
//                                                int64_t> values, int num_rows)
// {
//   // numRows += num_rows;
...
//   transform(
//     handle, d_rows.view(), d_cols.view(), d_vals.view(), nnz, results, bm25_on, k_param,
//     b_param);
// }
