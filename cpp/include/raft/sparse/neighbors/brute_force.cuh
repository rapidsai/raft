 ...
 */
template <typename value_t = float, typename idx_in = int, typename idx_out = int>
void knn(const idx_in* idxIndptr,
         ...
         float metricArg                     = 0)
{
  detail::sparse_knn_t<value_t, idx_in, idx_out>(idxIndptr,
                                                 idxIndices,
                                                 idxData,
                                                 idxNNZ,
                                                 n_idx_rows,
