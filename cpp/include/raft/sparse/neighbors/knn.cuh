 ...
 */
template <typename value_t = float, typename idx_in = int, typename idx_out = int, int TPB_X = 32>
void brute_force_knn(const idx_in* idxIndptr,
                     const idx_in* idxIndices,
                     const value_t* idxData,
                     size_t idxNNZ,
                     int n_idx_rows,
                     int n_idx_cols,
                     const idx_in* queryIndptr,
                     const idx_in* queryIndices,
                     ...
                     float metricArg                     = 0)
{
  brute_force::knn<value_t, idx_in, idx_out>(idxIndptr,
                                             idxIndices,
                                             idxData,
                                             idxNNZ,
                                             n_idx_rows,
