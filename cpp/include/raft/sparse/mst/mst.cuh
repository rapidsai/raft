...
raft::Graph_COO<vertex_t, edge_t, weight_t> mst(
  ...
  cudaStream_t stream, bool symmetrize_output = true, bool initialize_colors = true, int iterations = 0) {
  MST_solver<vertex_t, edge_t, weight_t> mst_solver(
    handle, offsets, indices, weights, v, e, color, stream, symmetrize_output, initialize_colors, iterations);
