...
{
  // RAFT_LOG_INFO("index_params_ n_lists %u, kmeans_n_iters %u, kmeans_trainset_fraction %lf,
  // pq_bits %u, pq_dim %u", params.n_lists, params.kmeans_n_iters, params.kmeans_trainset_fraction,
