...
RAFT_KERNEL_ void meanKernelRowMajor(Type* mu, const Type* data, IdxType D, IdxType N)
{
...
RAFT_KERNEL_ void meanKernelColMajor(Type* mu, const Type* data, IdxType D, IdxType N)
{
