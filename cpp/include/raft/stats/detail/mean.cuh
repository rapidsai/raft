...
_RAFT_KERNEL void meanKernelRowMajor(Type* mu, const Type* data, IdxType D, IdxType N)
{
...
_RAFT_KERNEL void meanKernelColMajor(Type* mu, const Type* data, IdxType D, IdxType N)
{
