...
namespace raft {
namespace distance {
extern template void distance<raft::distance::DistanceType::L1, float, float,
                              float, int>(const float *x, const float *y,
                                          float *dist, int m, int n, int k,
                                          void *workspace, size_t worksize,
                                          cudaStream_t stream, bool isRowMajor,
                                          float metric_arg);

extern template void distance<raft::distance::DistanceType::L1, double, double,
