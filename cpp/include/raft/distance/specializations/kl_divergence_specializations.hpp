...
distance<raft::distance::DistanceType::KLDivergence, float, float, float, int>(
...
extern template void distance<raft::distance::DistanceType::KLDivergence,
                              double, double, double, int>(
  const double *x, const double *y, double *dist, int m, int n, int k,
  void *workspace, size_t worksize, cudaStream_t stream, bool isRowMajor,
  double metric_arg);

extern template void distance<raft::distance::DistanceType::KLDivergence, float,
