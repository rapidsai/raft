...
extern template void
  pairwise_matrix_instantiation_point<ops::russel_rao_distance_op<float, float, int>,
                                      int,
                                      float,
                                      float,
...
extern template void
  pairwise_matrix_instantiation_point<ops::russel_rao_distance_op<double, double, int>,
                                      int,
                                      double,
                                      double,
                                      decltype(raft::identity_op())>(
