...
RAFT_KERNEL_ void perform_post_filter_registers(const value_t* X,
                                                value_int n_cols,
...
template <typename value_idx,
          ...
          int tpb      = 128,
          int col_q    = 2>
RAFT_KERNEL_ void compute_final_dists_registers(const value_t* X_index,
                                                const value_t* X,
...
template <typename value_idx = std::int64_t,
          ...
          typename value_int = std::uint32_t,
          typename distance_func>
RAFT_KERNEL_ void block_rbc_kernel_registers(const value_t* X_index,
                                             const value_t* X,
