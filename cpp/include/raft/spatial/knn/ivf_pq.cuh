 ...
 * @param[in] dataset a managed pointer to a row-major matrix [n_rows, dim]
 ...
 * @param[in] new_vectors a managed pointer to a row-major matrix [n_rows, index.dim()]
 * @param[in] new_indices a managed pointer to a vector of indices [n_rows].
