...
/** @} */
  ...
  DI void custom_next(GenType gen, OutType *val, InvariantDistParams<OutType> params, LenType idx, LenType stride) {
    *val = params.const_val;
  }

  template <typename GenType, typename OutType, typename LenType>
  DI void custom_next(GenType gen, OutType *val, UniformDistParams<OutType> params, LenType idx, LenType stride) {
    OutType res;
    gen.next(res);
  ...
  DI void custom_next(GenType gen, IntType *val, NormalIntDistParams<IntType> params, LenType idx, LenType stride) {
  ...
  template <typename GenType, typename OutType, typename LenType>
  DI void custom_next(GenType gen, OutType *val, NormalTableDistParams<OutType, LenType> params, LenType idx, LenType stride) {
    OutType res1, res2;
    gen.next(res1);
    gen.next(res2);
  ...
  DI void custom_next(GenType gen, OutType *val, BernoulliDistParams<Type> params, LenType idx, LenType stride) {
    Type res = 0;
    gen.next(res);
    *val = res > params.prob;
  }
  ...
  template <typename GenType, typename OutType, typename LenType>
  DI void custom_next(GenType gen, OutType *val, ScaledBernoulliDistParams<OutType> params, LenType idx, LenType stride) {
    OutType res = 0;
    gen.next(res);
  ...
  template <typename GenType, typename OutType, typename LenType>
  DI void custom_next(GenType gen, OutType *val, GumbelDistParams<OutType> params, LenType idx, LenType stride) {
    OutType res = 0;
    gen.next(res);
  ...
  template <typename GenType, typename OutType, typename LenType>
  DI void custom_next(GenType gen, OutType *val, LogNormalDistParams<OutType> params, LenType idx, LenType stride) {
  ...
  template <typename GenType, typename OutType, typename LenType>
  DI void custom_next(GenType gen, OutType *val, LogisticDistParams<OutType> params, LenType idx, LenType stride) {
    OutType res;
    gen.next(res);
  ...
  template <typename GenType, typename OutType, typename LenType>
  DI void custom_next(GenType gen, OutType *val, ExponentialDistParams<OutType> params, LenType idx, LenType stride) {
    OutType res;
    gen.next(res);
    constexpr OutType one = (OutType)1.0;
  ...
  template <typename GenType, typename OutType, typename LenType>
  DI void custom_next(GenType gen, OutType *val, RayleighDistParams<OutType> params, LenType idx, LenType stride) {
    OutType res;
    gen.next(res);
    constexpr OutType one = (OutType)1.0;
  ...
  template <typename GenType, typename OutType, typename LenType>
  DI void custom_next(GenType gen, OutType *val, LaplaceDistParams<OutType> params, LenType idx, LenType stride) {
    OutType res, out;
    gen.next(res);
    constexpr OutType one = (OutType)1.0;
    constexpr OutType two = (OutType)2.0;
  ...
  template <typename GenType, typename OutType, typename LenType>
  DI void custom_next(GenType gen, OutType *val, SamplingParams<OutType, LenType> params, LenType idx, LenType stride) {
    OutType res;
    gen.next(res);
