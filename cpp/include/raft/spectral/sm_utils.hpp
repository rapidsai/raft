...
static __device__ __forceinline__ unsigned int ballot(int p,
...
static __device__ __forceinline__ int shfl(int r, int lane, int bound = 32,
                                           int mask = DEFAULT_MASK) {
#if __CUDA_ARCH__ >= 300
#if USE_CG
 ...
 *
 */
static __device__ __forceinline__ double shfl(double r, int lane,
                                              int bound = 32,
                                              int mask = DEFAULT_MASK) {
#if __CUDA_ARCH__ >= 300
#ifdef USE_CG
...
static __device__ __forceinline__ long long shfl(long long r, int lane,
                                                 int bound = 32,
                                                 int mask = DEFAULT_MASK) {
#if __CUDA_ARCH__ >= 300
#ifdef USE_CG
...
static __device__ __forceinline__ int shfl_down(int r, int offset,
                                                int bound = 32,
                                                int mask = DEFAULT_MASK) {
#if __CUDA_ARCH__ >= 300
#ifdef USE_CG
...
static __device__ __forceinline__ long long shfl_down(long long r, int offset,
                                                      int bound = 32,
                                                      int mask = DEFAULT_MASK) {
#if __CUDA_ARCH__ >= 300
#ifdef USE_CG
...
static __device__ __forceinline__ uint64_t shfl_down(uint64_t r, int offset,
                                                     int bound = 32,
                                                     int mask = DEFAULT_MASK) {
#if __CUDA_ARCH__ >= 300
#ifdef USE_CG
...
static __device__ __forceinline__ int shfl_up(int r, int offset, int bound = 32,
                                              int mask = DEFAULT_MASK) {
#if __CUDA_ARCH__ >= 300
#ifdef USE_CG
...
static __device__ __forceinline__ float shfl_up(float r, int offset,
                                                int bound = 32,
                                                int mask = DEFAULT_MASK) {
#if __CUDA_ARCH__ >= 300
#ifdef USE_CG
...
static __device__ __forceinline__ double shfl_up(double r, int offset,
                                                 int bound = 32,
                                                 int mask = DEFAULT_MASK) {
#if __CUDA_ARCH__ >= 300
#ifdef USE_CG
...
static __device__ __forceinline__ long long shfl_up(long long r, int offset,
                                                    int bound = 32,
                                                    int mask = DEFAULT_MASK) {
#if __CUDA_ARCH__ >= 300
#ifdef USE_CG
